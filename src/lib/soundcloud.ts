...
export async function searchMock(query: string): Promise<Song[]> {
  const mockSongs: Song[] = [
    ...
    // ===== Telugu Film Songs =====
    {
      id: 'tel-1',
      title: 'Naatu Naatu',
      artist: 'Vishal Mishra, Rahul Sipligunj, Sireesha',
      coverUrl: getAlbumCover('Naatu Naatu'),
      duration: 275,
      source: 'youtube',
    ...
    },
    {
      ...
      artist: 'Sid Sriram',
      coverUrl: getAlbumCover('Samajavaragamana'),
      duration: 279,
      source: 'youtube',
    ...
    },
    {
      id: 'tel-3',
      title: 'Butta Bomma',
      artist: 'Anurag Kulkarni, Jyotica Tangri',
      coverUrl: getAlbumCover('Butta Bomma'),
      duration: 263,
      source: 'youtube',
    ...
    },
    {
      ...
      title: 'Srivalli',
      artist: 'Sid Sriram',
      coverUrl: getAlbumCover('Srivalli'),
      duration: 294,
      source: 'youtube',
    ...
    },
    {
      ...
      coverUrl: getAlbumCover('Oo Antava Oo Oo Antava'),
      duration: 286,
      source: 'youtube',
    ...
    },
    {
      ...
      artist: 'Hariharan, Swetha Logan',
      coverUrl: getAlbumCover('Inkem Inkem Inkem Kaavaale'),
      duration: 276,
      source: 'youtube',
    ...
    },
    {
      ...
      coverUrl: getAlbumCover('Nee Kannu Neeli Samudram'),
      duration: 291,
      source: 'youtube',
    ...
    },
    {
      ...
      coverUrl: getAlbumCover('Kalaavathi'),
      duration: 253,
      source: 'youtube',
    ...
    },
    {
      ...
      artist: 'Mangli, Sramya Kanneganti',
      coverUrl: getAlbumCover('Komuram Bheemudo'),
      duration: 240,
      source: 'youtube',
    ...
    // ===== Christian Telugu Songs =====
    {
      ...
      title: 'Yesu Naamame',
      artist: 'Jeswin Smith',
      coverUrl: getAlbumCover('Yesu Naamame'),
      duration: 290,
      source: 'youtube',
    ...
    },
    {
      ...
      artist: 'Sharon',
      coverUrl: getAlbumCover('Neevu Chesina Upakaramulaku'),
      duration: 310,
      source: 'youtube',
    ...
    },
    {
      ...
      artist: 'Lotson Felix',
      coverUrl: getAlbumCover('Daivam Maitho Undi'),
      duration: 345,
      source: 'youtube',
    ...
    },
    {
      ...
      coverUrl: getAlbumCover('Aradhana'),
      duration: 320,
      source: 'youtube',
    ...
    },
    {
      ...
      coverUrl: getAlbumCover('Cross Meda Prema'),
      duration: 280,
      source: 'youtube',
    ...
    },
    {
      ...
      coverUrl: getAlbumCover('Premikosam'),
      duration: 270,
      source: 'youtube',
    ...
    },
    {
      ...
      artist: 'Ravi Prolaya',
      coverUrl: getAlbumCover('Sthorelo Manase'),
      duration: 295,
      source: 'youtube',
    ...
    },
    {
      ...
      title: 'Snehithuda',
      artist: 'Ravi Prolaya',
      coverUrl: getAlbumCover('Snehithuda'),
      duration: 310,
      source: 'youtube',
    ...
    },
    {
      ...
      title: 'Devuni Prema',
      artist: 'Salom Morgan',
      coverUrl: getAlbumCover('Devuni Prema'),
      duration: 335,
      source: 'youtube',
    ...
    // ===== Christian English Songs =====
    {
      ...
      title: 'Way Maker',
      artist: 'Sinach',
      coverUrl: getAlbumCover('Way Maker'),
      duration: 258,
      source: 'youtube',
    ...
    },
    {
      ...
      coverUrl: getAlbumCover('What a Beautiful Name'),
      duration: 314,
      source: 'youtube',
    ...
    },
    {
      ...
      artist: 'Matt Redman',
      coverUrl: getAlbumCover('10,000 Reasons'),
      duration: 314,
      source: 'youtube',
    ...
    },
    {
      ...
      artist: 'Bethel Music',
      coverUrl: getAlbumCover('Goodness of God'),
      duration: 325,
      source: 'youtube',
    ...
    },
    {
      ...
      artist: 'Chris Tomlin',
      coverUrl: getAlbumCover('Amazing Grace'),
      duration: 285,
      source: 'youtube',
    ...
    },
    {
      ...
      coverUrl: getAlbumCover('Oceans Where Feet May Fail'),
      duration: 303,
      source: 'youtube',
